...
## Acceptance Criteria
- [x] Every `DeadlockEvent` and `CollisionEvent` recorded with timestamp and vehicle IDs
- [x] Log volume capped/rotated to avoid unbounded memory growth in long-running sessions
