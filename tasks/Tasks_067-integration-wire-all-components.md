...
## Acceptance Criteria
- [ ] Simulation Orchestrator composes Physics Engine, Signal Controller, Conflict Zone Manager, Vehicle Manager, Collision Detection, Emergency Vehicle Controller, Metrics Collector, Telemetry, Renderer, and UI Controller per the [ARCHITECTURE.md](../docs/ARCHITECTURE.md) component map
- [ ] `npm run dev` launches a working end-to-end simulation in-browser with all UI controls functional
